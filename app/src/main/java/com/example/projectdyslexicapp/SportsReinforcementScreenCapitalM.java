...
public class SportsReinforcementScreenCapitalM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sports_reinforcement_screen_capital_m);
        ...
        Button sports_retry = findViewById(R.id.replay_button_sport_m_capital_reinforcement);
        Button sports_back  = findViewById(R.id.menu_button_sport_m_capital_reinforcement);
        ImageView home_button = findViewById(R.id.home_button);

        sports_retry.setOnClickListener(v -> {
            Intent intent = new Intent(SportsReinforcementScreenCapitalM.this, SportsReinforcementScreenCapitalM.class);
        ...
        sports_back.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(SportsReinforcementScreenCapitalM.this, SportsTrialScreenCapitalM.class);
            startActivity(intent);
        ...
        home_button.setOnClickListener(v -> {
            // Enable slide transition when pressing "Next" button
            Intent intent = new Intent(SportsReinforcementScreenCapitalM.this, SportsCapitalLetterMenu.class);
            startActivity(intent);
            overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
        });
