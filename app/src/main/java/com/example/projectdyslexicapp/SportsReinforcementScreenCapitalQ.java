...
public class SportsReinforcementScreenCapitalQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sports_reinforcement_screen_capital_q);
        ...
        Button sports_retry = findViewById(R.id.replay_button_sport_q_capital_reinforcement);
        Button sports_back  = findViewById(R.id.menu_button_sport_q_capital_reinforcement);
        ImageView home_button = findViewById(R.id.home_button);

        sports_retry.setOnClickListener(v -> {
            Intent intent = new Intent(SportsReinforcementScreenCapitalQ.this, SportsReinforcementScreenCapitalQ.class);
        ...
        sports_back.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(SportsReinforcementScreenCapitalQ.this, SportsTrialScreenCapitalQ.class);
            startActivity(intent);
        ...
        home_button.setOnClickListener(v -> {
            // Enable slide transition when pressing "Next" button
            Intent intent = new Intent(SportsReinforcementScreenCapitalQ.this, SportsCapitalLetterMenu.class);
            startActivity(intent);
            overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
        });
