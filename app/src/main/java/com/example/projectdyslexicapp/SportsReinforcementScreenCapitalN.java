...
public class SportsReinforcementScreenCapitalN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sports_reinforcement_screen_capital_n);
        ...
        Button sports_retry = findViewById(R.id.replay_button_sport_n_capital_reinforcement);
        Button sports_back  = findViewById(R.id.menu_button_sport_n_capital_reinforcement);
        ImageView home_button = findViewById(R.id.home_button);

        sports_retry.setOnClickListener(v -> {
            Intent intent = new Intent(SportsReinforcementScreenCapitalN.this, SportsReinforcementScreenCapitalN.class);
        ...
        sports_back.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(SportsReinforcementScreenCapitalN.this, SportsTrialScreenCapitalN.class);
            startActivity(intent);
        ...
        home_button.setOnClickListener(v -> {
            // Enable slide transition when pressing "Next" button
            Intent intent = new Intent(SportsReinforcementScreenCapitalN.this, SportsCapitalLetterMenu.class);
            startActivity(intent);
            overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
        });
